public class Main {
    public static void main(String[] args) {
        ...
        Teacher t3 = new Teacher("Jan", "Jabola", TeacherCondition.obecny, 1984, 2112);
        Teacher t4 = new Teacher("Krzysztof", "Tomaszewski", TeacherCondition.obecny, 1999, 2000);

        cont.grupy.get("Klasa1").addTeacher(t1);
        cont.grupy.get("Klasa1").addTeacher(t2);
        cont.grupy.get("Klasa1").addTeacher(t4);
        cont.grupy.get("Klasa1").addTeacher(t4); // błąd

        System.out.printf("%d pustych klas\n", cont.findEmpty().size());

        System.out.println("\nNauczyciele z Klasy 1 o imieniu / nazwisku z \"Toma\":");
        cont.grupy.get("Klasa1").findPartial("Toma").forEach(a -> System.out.printf("%s %s\n", a.imie, a.nazwisko));
